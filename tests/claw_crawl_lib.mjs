// Shared loader for the Claw Crawl suites.
//
// claw_crawl/index.html is one self-contained file: markup, CSS and a single
...
const HTML = path.join(__dirname, '..', 'claw_crawl', 'index.html');
...
const EXPOSE = `__out.api = {
  ...
  clawPlan, clawMove, clawSegs, initClaw, clawSize, clawGrip, useItem, applyFx, collect, playerTurnStart, endPlayerTurn,
  ...
  saveRun, loadRunData, loadMeta, ACT, onDown, onMove, onUp, draw, update, fit, syncBars, R,
};
`;
